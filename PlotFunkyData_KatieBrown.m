...
games_header=find(strcmp(headers,'games_hours'));
grade_header=find(strcmp(headers,'Exam1'));

figure(2);
set(gcf,'Name', 'Do computers rot your brain?');
subplot(1,3,1)
plot([data{:,games_header}], [data{:, grade_header}], 'ko');
xlabel('Hours playing video games')
ylabel('grade')
...
set(gcf,'Name', 'Do computers rot your brain?');
subplot(1,3,1)
plot([data{:, sleep_header}], [data{:,games_header}], 'ko');
xlabel('Hours of sleep')
ylabel('Hours playing video games')
...
sleep_header=find(strcmp(headers,'sleep'));
exam_header=find(strcmp(headers,'Exam1'));

figure(2);
set(gcf,'Name', 'Do computers rot your brain?');
subplot(1,3,1)
plot([data{:, sleep_header}], [data{:,exam_header}], 'ko');
xlabel('Hours of sleep')
ylabel('Exam score')
